...
if(isset($_POST['login']) || isset($_POST['signup'])){
	...
	if(isset($_POST['login'])){
     ...
     if(strlen($sign_phone)!=10){
        return (header("location:checking.html"));  
     }
...
<body background="images/res.jpg">
	...
	<div id="id02" class="modal">
  		<form class="modal-content animate" method="POST" >
    		...
    		<div class="container">
				...
				<div id="sign_error_msg" class="error_msg"><?php if($error_msg=="email alrdy exsit") echo $error_msg;?></div>
	...
	<div class="navbar">
  		...
  		<div class="copy">&copy;hungrzy</div>
